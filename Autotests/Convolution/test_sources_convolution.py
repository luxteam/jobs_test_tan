...
class TestSources:
    ...
    @allure.description("""Overlap Add GPU NoAngel FishbowlCondenser""")
    ...
    @allure.description("""Uniform Partitioned GPU NoAngel FishbowlCondenser""")
    @pytest.mark.timeout(150)
    ...
    @allure.description("""Non-uniform partitioned GPU NoAngel FishbowlCondenser""")
    @pytest.mark.timeout(150)
    ...
    @allure.description("""Overlap Add CPU NoAngel FishbowlCondenser""")
    @pytest.mark.timeout(150)
    ...
    @allure.description("""Uniform partitioned CPU NoAngel FishbowlCondenser""")
    @pytest.mark.timeout(150)
    @allure.issue('https://adc.luxoft.com/jira/browse/STVITT-54', 'CPU modes don\'t work')
    @pytest.mark.xfail(condition=lambda: True, reason='CPU mode does not work')
    ...
    @allure.description("""Non-uniform partitioned CPU NoAngel FishbowlCondenser""")
    @pytest.mark.timeout(150)
    @allure.issue('https://adc.luxoft.com/jira/browse/STVITT-54', 'CPU modes don\'t work')
    @pytest.mark.xfail(condition=lambda: True, reason='CPU mode does not work')
    ...
    @allure.description("""Overlap Add GPU NoAngel AON-18""")
    ...
    @allure.description("""Uniform Partitioned GPU NoAngel AON-18""")
    @pytest.mark.timeout(300)
    ...
    @allure.description("""Non-uniform partitioned GPU NoAngel AON-18""")
    @pytest.mark.timeout(300)
    ...
    @allure.description("""Overlap Add CPU NoAngel AON-18""")
    @pytest.mark.timeout(300)
    @allure.issue('https://adc.luxoft.com/jira/browse/STVITT-54', 'CPU modes don\'t work')
    @pytest.mark.xfail(condition=lambda: True, reason='CPU mode does not work')
    ...
    @allure.description("""Uniform partitioned CPU NoAngel AON-18""")
    @pytest.mark.timeout(300)
    @allure.issue('https://adc.luxoft.com/jira/browse/STVITT-54', 'CPU modes don\'t work')
    @pytest.mark.xfail(condition=lambda: True, reason='CPU mode does not work')
    ...
    @allure.description("""Non-uniform partitioned CPU NoAngel AON-18""")
    @pytest.mark.timeout(300)
    @allure.issue('https://adc.luxoft.com/jira/browse/STVITT-54', 'CPU modes don\'t work')
    @pytest.mark.xfail(condition=lambda: True, reason='CPU mode does not work')
    ...
    @allure.title("CONV_SRC_013")
    @allure.description("""Overlap Add GPU NoAngel Badger""")
    @pytest.mark.timeout(300)
    @allure.issue('https://adc.luxoft.com/jira/browse/STVITT-53', 'GPU-OV causes error')
    @pytest.mark.xfail(condition=lambda: True, reason='Error after outputing file')
    def test_src_013(self):
        runConvolution("GPU-OV", "NoAngel.wav", "src_013.wav", "MechaAnimal/Badger-dynamic.wav", "NoAngelBadgerEffect.wav")
        
    @allure.title("CONV_SRC_014")
    @allure.description("""Uniform Partitioned GPU NoAngel Badger""")
    @pytest.mark.timeout(300)
    def test_src_014(self):
        runConvolution("GPU-UN", "NoAngel.wav", "src_014.wav", "MechaAnimal/Badger-dynamic.wav", "NoAngelBadgerEffect.wav")

    @allure.title("CONV_SRC_015")
    @allure.description("""Non-uniform partitioned GPU NoAngel Badger""")
    @pytest.mark.timeout(300)
    def test_src_015(self):
        runConvolution("GPU-NU", "NoAngel.wav", "src_015.wav", "MechaAnimal/Badger-dynamic.wav", "NoAngelBadgerEffect.wav")

    @allure.title("CONV_SRC_016")
    @allure.description("""Overlap Add CPU NoAngel Badger""")
    @pytest.mark.timeout(300)
    @allure.issue('https://adc.luxoft.com/jira/browse/STVITT-54', 'CPU modes don\'t work')
    @pytest.mark.xfail(condition=lambda: True, reason='CPU mode does not work')
    def test_src_016(self):
        runConvolution("CPU-OV", "NoAngel.wav", "src_016.wav", "MechaAnimal/Badger-dynamic.wav", "NoAngelBadgerEffect.wav")

    @allure.title("CONV_SRC_017")
    @allure.description("""Uniform partitioned CPU NoAngel Badger""")
    @pytest.mark.timeout(300)
    @allure.issue('https://adc.luxoft.com/jira/browse/STVITT-54', 'CPU modes don\'t work')
    @pytest.mark.xfail(condition=lambda: True, reason='CPU mode does not work')
    def test_src_017(self):
        runConvolution("CPU-UN", "NoAngel.wav", "src_017.wav", "MechaAnimal/Badger-dynamic.wav", "NoAngelBadgerEffect.wav")

    @allure.title("CONV_SRC_018")
    @allure.description("""Non-uniform partitioned CPU NoAngel Badger""")
    @pytest.mark.timeout(300)
    @allure.issue('https://adc.luxoft.com/jira/browse/STVITT-54', 'CPU modes don\'t work')
    @pytest.mark.xfail(condition=lambda: True, reason='CPU mode does not work')
    def test_src_018(self):
        runConvolution("CPU-NU", "NoAngel.wav", "src_018.wav", "MechaAnimal/Badger-dynamic.wav", "NoAngelBadgerEffect.wav")
