...
class TestSmoke:
    ...
    def test_conv_001(self):
        runConvolution("GPU-OV", "smokeIn.wav", "conv_001.wav", "../IRs/testresponse.wav", "conv_001.wav")

    @allure.title("CONV_SM_002")
    @allure.description("""Uniform Partitioned GPU""")
    @pytest.mark.timeout(150)
    def test_conv_002(self):
        runConvolution("GPU-UN", "smokeIn.wav", "conv_002.wav", "../IRs/testresponse.wav", "conv_001.wav")

    @allure.title("CONV_SM_003")
    @allure.description("""Non-uniform partitioned GPU""")
    @pytest.mark.timeout(150)
    def test_conv_003(self):
        runConvolution("GPU-NU", "smokeIn.wav", "conv_003.wav", "../IRs/testresponse.wav", "conv_001.wav")
    ...
    def test_conv_004(self):
        runConvolution("CPU-OV", "smokeIn.wav", "conv_004.wav", "../IRs/testresponse.wav", "conv_001.wav")
    ...
    def test_conv_005(self):
        runConvolution("CPU-UN", "smokeIn.wav", "conv_005.wav", "../IRs/testresponse.wav", "conv_001.wav")
    ...
    def test_conv_006(self):
        runConvolution("CPU-NU", "smokeIn.wav", "conv_006.wav", "../IRs/testresponse.wav", "conv_001.wav")
